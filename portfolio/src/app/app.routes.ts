...
} from './components/programming/side-projects/python-applications/ipa-picker-latex-converter/ipa-picker-latex-converter.component';
...
} from './components/programming/side-projects/python-applications/python-applications.component';
import {Routes} from '@angular/router';
import {SideProjectsComponent} from './components/programming/side-projects/side-projects.component';
import {
  SimpleCalculatorComponent
} from './components/programming/side-projects/python-applications/simple-calculator/simple-calculator.component';
import {
  SimpleDutchWeatherAppComponent
} from './components/programming/side-projects/python-applications/simple-dutch-weather-app/simple-dutch-weather-app.component';
...
export const routes: Routes = [
  ...
  {path: 'ipa-picker-latex-converter', component: IpaPickerLatexConverterComponent},
  ...
  {path: 'python-applications', component: PythonApplicationsComponent},
